import {
  ...
  export default function ViewQAFI({navigation, route}) {
    ...
    const fetchComments = async value => {
      ...
      try {
        const response = await fetch(
          `https://watch-gotcha-be.mtechub.com/qafi/getAllCommentsByQAFI/${receivedData?.qafi_id}`,
          {
            method: 'GET',
            headers: {
    ...
    const fetchLikes = async values => {
      ...
      try {
        const response = await fetch(
          `https://watch-gotcha-be.mtechub.com/qafi/getAllLikesByQafi/${receivedData?.qafi_id}`,
          {
            method: 'GET',
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const sendComment = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          'https://watch-gotcha-be.mtechub.com/qafi/sendComment',
          commentData,
          axiosConfig,
        );
    ...
    const sendLikes = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          'https://watch-gotcha-be.mtechub.com/qafi/likeUnlikeQafi',
          commentData,
          axiosConfig,
        );
