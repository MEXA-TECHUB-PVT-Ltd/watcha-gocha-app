...
export default function Video({navigation}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Headers showListings={true} onPressSearch={()=>navigation.navigate('SearchScreen')} showText={true} text={'XPi/3.14 videos'} showSearch={true}/>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate("UploadUpdateVideo")} style={{position: 'absolute', bottom: 1, right: 25}}>
        <Add />
      </TouchableOpacity>
    </View>
  );
