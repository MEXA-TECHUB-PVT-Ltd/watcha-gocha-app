  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{marginTop: hp(5)}}>
        <Headers showListings={true}  showLogo={true} onPressProfile={()=>navigation.navigate("ViewProfile")} showProfileImage={true} />
      </View>
      ...
      <ScrollView
       ...
       <View
        ...
        <Text
            style={{color: '#FACA4E', marginLeft:wp(3), fontFamily: 'Inter-Bold', fontSize: hp(2.3)}}>
            Pi/3.14 Videos
          </Text>
      ...
      <View
        ...
        <Text
            style={{color: '#FACA4E', marginLeft:wp(5), fontFamily: 'Inter-Bold', fontSize: hp(2.3)}}>
            Pic Tours
          </Text>
