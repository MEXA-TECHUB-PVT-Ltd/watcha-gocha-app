...
export default function ViewNews({navigation, route}) {
  ...
  const fetchComments = async value => {
    ...
    try {
      const response = await fetch(
        `https://watch-gotcha-be.mtechub.com/news/getAllCommentsByNews/${receivedData?.news_id}`,
        {
          method: 'GET',
          headers: {
  ...
  const fetchLikes = async values => {
    ...
    try {
      const response = await fetch(
        `https://watch-gotcha-be.mtechub.com/news/getAllLikesByNews/${receivedData?.news_id}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const sendComment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://watch-gotcha-be.mtechub.com/news/sendComment',
        commentData,
        axiosConfig,
      );
  ...
  const sendLikes = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://watch-gotcha-be.mtechub.com/news/likeUnlikeNews',
        commentData,
        axiosConfig,
      );
