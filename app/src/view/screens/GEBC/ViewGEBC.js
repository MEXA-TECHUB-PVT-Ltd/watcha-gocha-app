...
export default function ViewGEBC({navigation, route}) {
  ...
  const fetchComments = async value => {
    ...
    try {
      const response = await fetch(
        `https://watch-gotcha-be.mtechub.com/gebc/getAllCommentsByGEBC/${receivedData?.gebc_id}`,
        {
          method: 'GET',
          headers: {
  ...
  const fetchLikes = async values => {
    ...
    try {
      const response = await fetch(
        `https://watch-gotcha-be.mtechub.com/gebc/getAllLikesByGEBC/${receivedData?.gebc_id}`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const sendComment = async () => {
    ...
    try {
      ...
      const commentData = {
        GEBC_id: receivedData?.gebc_id,
        user_id: userId,
        comment: commentText,
      };

      const response = await axios.post(
        'https://watch-gotcha-be.mtechub.com/gebc/sendComment',
        commentData,
        axiosConfig,
      );
  ...
  const sendLikes = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://watch-gotcha-be.mtechub.com/gebc/likeUnlikeGEBC',
        commentData,
        axiosConfig,
      );
